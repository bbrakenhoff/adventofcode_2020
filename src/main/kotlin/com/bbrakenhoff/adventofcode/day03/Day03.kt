...
class Day03() : Day {
    ...
    override fun partOne(): String {
        val treeCount = Slope(3, 1).countTreesInSlope()
        return "$treeCount"
    }

    override fun partTwo(): String { //        TODO("Not yet implemented")
        val slopeRight1Down1 = Slope(1, 1)
        val slopeRight3Down1 = Slope(3, 1)
        val slopeRight5Down1 = Slope(5, 1)
        val slopeRight7Down1 = Slope(7, 1)
        val slopeRight1Down2 = Slope(1, 2)
